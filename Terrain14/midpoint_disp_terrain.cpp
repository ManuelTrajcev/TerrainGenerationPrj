...
void MidpointDispTerrain::CreateMidpointDisplacement(int TerrainSize, int NumPatches, float Roughness, float MinHeight, float MaxHeight)
{
    if (Roughness < 0.0f) {
    ...
    m_heightMap.Normalize(MinHeight, MaxHeight, 1.0f);
