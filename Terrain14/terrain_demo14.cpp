...
private:
	...
	void CreateWindow_()
	{
		...
		window = glfw_init(major_ver, minor_ver, WINDOW_WIDTH, WINDOW_HEIGHT, is_full_screen, "Terrain Rendering - Demo 14");
	...
	void InitTerrain()
	{
		...
		TextureFilenames.push_back("../Content/dry-rocky-ground-bl/dry-rocky-ground_albedo.png");
		TextureFilenames.push_back("../Content/dry-rocky-ground-bl/dry-rocky-ground_roughness.png");
		TextureFilenames.push_back("../Content/dry-rocky-ground-bl/dry-rocky-ground_metallic.png");
		TextureFilenames.push_back("../Content/dry-rocky-ground-bl/dry-rocky-ground_normal-ogl.png");
